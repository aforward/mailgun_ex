defmodule MailgunEx.RequestTest do
  ...
  test "Use configs for https_opts if opts key not provided" do
    ...
    assert [timeout: 5000, params: [limit: 10]]
      == Request.create(params: [limit: 10]).http_opts
  end
  ...
  test "Send an valid request" do
    {:ok, %HTTPoison.Response{} = resp} = Request.send(%Request{url: "https://raw.githubusercontent.com/work-samples/mailgun_ex/master/LICENSE"}, :get)
